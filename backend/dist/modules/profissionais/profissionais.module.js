    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: profissional_schema_1.Profissional.name, schema: profissional_schema_1.ProfissionalSchema },
            ]),
        ],
        controllers: [profissionais_controller_1.ProfissionaisController],
        providers: [profissionais_service_1.ProfissionaisService],
        exports: [profissionais_service_1.ProfissionaisService, mongoose_1.MongooseModule],
    })
], ProfissionaisModule);
