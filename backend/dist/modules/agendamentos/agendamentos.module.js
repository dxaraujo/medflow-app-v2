    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: agendamento_schema_1.Agendamento.name, schema: agendamento_schema_1.AgendamentoSchema },
            ]),
        ],
        controllers: [agendamentos_controller_1.AgendamentosController],
        providers: [agendamentos_service_1.AgendamentosService],
        exports: [agendamentos_service_1.AgendamentosService, mongoose_1.MongooseModule],
    })
], AgendamentosModule);
